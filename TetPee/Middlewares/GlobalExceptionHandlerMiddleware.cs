...
namespace TetPee.Middlewares;

public class GlobalExceptionHandlerMiddleware : IMiddleware
{
    private readonly IHostEnvironment _environment;// phiên bản dev: trả lỗi chi tiết hơn, hay production: trả lỗi ngắn để đọc các log khác
